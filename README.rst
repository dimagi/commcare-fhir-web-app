...
A reference implementation of a web app that communicates with CommCare using FHIR
...
For convenience, you can keep your normal user logged in on one browser and your
superuser logged in on another browser, so that you can see how the site behaves
